...
peep.Instance = (function() {
  ...
  function Instance(node) {
    ...
    this.services = dataset.services || 'Twitter, Facebook, Pinterest';
...
peep.Service = (function() {
  ...
  Service.prototype.callback = function(res) {
    ...
    return count.innerHTML = res.shares || res.count || 0;
  };
...
peep.Pinterest = (function(_super) {
  ...
  function Pinterest(node, id, url, title) {
    ...
    this.endpoints = {
      share: "https://pinterest.com/pin/create/button/?url=" + this.url + "&description=" + this.title,
